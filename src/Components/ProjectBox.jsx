...
const ProjectBox = ({ projectPhoto, projectName }) => {
  const desc = {
      ...
      CouponGeneratorDesc:
      "esigned to create and manage unique coupon codes with customizable parameters. Users can specify the format, length, expiration date, and discount amount for each coupon generated. The project provides a responsive web interface for easy accessibility from various devices.",
